    ...
    <div className="w-full">
      ...
      <div className="relative rounded-lg shadow-xs">
        ...
        <input
          ref={ref}
          id={inputId}
          className={`w-full rounded-lg border bg-slate-900/80 px-3.5 py-2 text-sm text-slate-100 placeholder-slate-500 transition focus:outline-none focus:ring-2 ${
            leftIcon ? 'pl-10' : ''
          } ${rightIcon ? 'pr-10' : ''} ${
            error
